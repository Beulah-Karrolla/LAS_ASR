...
def main():
    ...
    parser.add_argument('--input_size', type=int, default=320, help='')
    parser.add_argument('--hidden_size', type=int, default=640, help='')
    ...
    parser.add_argument('--bidirectional_encoder', type=bool, default=True, help='')
    ...
    parser.add_argument('--sync-path', type=str, default='/home/karrolla.1/LAS/sync/shared', help='')
